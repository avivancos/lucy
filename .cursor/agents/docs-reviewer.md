---
name: docs-reviewer
description: Prevents code and documentation from diverging. Run when docs, ADRs, README, or docstrings were touched - or when code changed under them. Use proactively when the review gate or card workflow applies.
---
...
- Entries marked `needs-ADR` or `needs-spec-update` in the Decision log must
  produce an ADR, a doc change, or a follow-up card.
