...
description: Keeps code as small and direct as the spec permits. Run on every card that touches src/ or tests/. Use proactively when the review gate or card workflow applies.
---
...
- Verdict may be PASS | FAIL | BLOCKED when missing evidence prevents a
  simplicity judgment.
