...
description: Challenges trust assumptions on changes touching telemetry, secrets, MCP permissions, or the public surface. Record NOT_APPLICABLE with a reason on cards that touch none of these. Use proactively when the review gate or card workflow applies.
---
...
- Treat spec-silent Decision log entries on trust boundaries as new attack
  surface. AI prompt/tool surfaces are in scope.
- Verdict may be PASS | FAIL | BLOCKED | NOT_APPLICABLE.
