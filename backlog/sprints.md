...
| S5 Native telephony | Telephony | 97, 40, 41, 42, 43, 44, 45 | Real call softphone -> Asterisk -> Lucy locally; real PSTN call via CPaaS with a Spanish DID |
...
| S9 Analytics & SRE observability | Platform/Runtime | 52, 53, 54, 55, 56, 57, 66, 67, 94, 98, 99 | Local run serves an analytics-model-v1 rollup at `/analytics`, Grafana renders RED/USE metrics, and the SDK emits full voice costs, talk-time attribution, provider/RAG attribution, and local budget enforcement |
